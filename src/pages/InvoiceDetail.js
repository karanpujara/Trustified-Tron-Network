...
export default function InvoiceDetail() {
  ...
  const handlePayNow = async (invc) => {
    ...
    var amount = tronWeb.toSun(amt); 
    const address = invc?.address;  
    const dd = await  tronWeb.trx.sendTransaction(address, amount);  
    setLoading(false); 
          ...
          <div className="container">
            <div className="panel panel-default mb-5">
              ...
              <div className="panel-footer" style={{ height: "10rem" }}>
                ...
                <div className="paynowLink" style={{float:'right'}}>
                  {/* <Button
                    style={{
                      color: "blue",
                      fontSize: "0.875rem",
